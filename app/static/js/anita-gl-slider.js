...
class Anita_GL_Slider {
  constructor(b, c = !1) {
    if (
      (b instanceof jQuery ? (this.$el = b) : (this.$el = jQuery(b)),
      !this.$el.length)
    )
      return console.warn("gl_Gallery: Element not found"), !1;
    if (!this.$el.children("div").length)
      return console.warn("gl_Gallery: There are no slides"), !1;
    if (
      ((this.options = {
      ...
      for (let [d, e] of Object.entries(c)) this.options[d] = e;
    let a = this;
    (this.loader = new THREE.TextureLoader()),
      (this.clock = new THREE.Clock()),
      (this.prevTime = 0),
      this.$el.css("transform", "translateX(0px)"),
      (this.screen_ratio = window.innerHeight / window.innerWidth),
      (this.isChanging = 0),
      (this.cameraFixed = 0),
      (this.scene = new THREE.Scene()),
      (this.fov =
        (180 *
          (2 * Math.atan(window.innerHeight / 2 / this.options.perspective))) /
        Math.PI),
      ...
      jQuery(this.renderer.domElement).addClass("anita-gl-slider-canvas"),
      (this.gallery = new Array()),
      this.$el.children("div").each(function (f) {
        let c = jQuery(this),
        ...
        if (
          ((b.ratio = d[1] / d[0]),
          "cover" == a.options.fit
            ? b.ratio > a.screen_ratio
              ? (b.zoom = new THREE.Vector2(1, a.screen_ratio / b.ratio))
              : this.ratio < a.screen_ratio
              ? (b.zoom = new THREE.Vector2(b.ratio / a.screen_ratio, 1))
              : (b.zoom = new THREE.Vector2(1, 1))
            : b.ratio > a.screen_ratio
            ? (b.zoom = new THREE.Vector2(b.ratio / a.screen_ratio, 1))
            : this.ratio < a.screen_ratio
            ? (b.zoom = new THREE.Vector2(1, a.screen_ratio / b.ratio))
          ...
          let e = jQuery(
            '<video src="' +
              c.attr("data-src") +
              '" webkit-playsinline="true" playsinline="true" muted ' +
              (0 == f ? "autoplay" : "") +
              " loop/>"
          );
      ...
      (this.active = 0),
      (this.max = this.gallery.length - 1),
      ...
      (this.moveEvent = {
        ...
        setNextImage: function () {
          (a.moveEvent.dir = 1),
            (a.moveEvent.targedID = a.active + 1),
            a.moveEvent.targedID > a.max && (a.moveEvent.targedID = 0),
            (a.screen.material.uniforms.dir.value = 1),
            (a.screen.material.uniforms.nextImage.value =
              a.gallery[a.moveEvent.targedID].src),
            (a.screen.material.uniforms.nextZoom.value =
              a.gallery[a.moveEvent.targedID].zoom);
        },
        setPrevImage: function () {
          (a.moveEvent.dir = -1),
            (a.moveEvent.targedID = a.active - 1),
            a.moveEvent.targedID < 0 && (a.moveEvent.targedID = a.max),
            (a.screen.material.uniforms.dir.value = -1),
            (a.screen.material.uniforms.nextImage.value =
              a.gallery[a.moveEvent.targedID].src),
            (a.screen.material.uniforms.nextZoom.value =
            ...
            a.moveEvent.active &&
              ...
              (b.touches
                ? (a.moveEvent.path =
                    ...
                    window.innerWidth)
                : (a.moveEvent.path =
                    (a.moveEvent.point - b.clientX) / window.innerWidth),
              0 === a.moveEvent.path && (a.moveEvent.dir = 0),
              0 === a.moveEvent.dir
                ? (a.moveEvent.path > 0 && a.moveEvent.setNextImage(),
                  a.moveEvent.path < 0 && a.moveEvent.setPrevImage(),
                  (a.screen.material.uniforms.progress.value = 0))
                : a.moveEvent.dir > 0 && a.moveEvent.path < 0
                ? a.moveEvent.setPrevImage()
                : a.moveEvent.dir < 0 && a.moveEvent.path > 0
                ? a.moveEvent.setNextImage()
                : (a.screen.material.uniforms.progress.value = Math.abs(
                    a.moveEvent.path
                  )));
        },
        f_End: function () {
          ...
          a.moveEvent.active &&
            (a.moveEvent.path > 0
              ? a.moveEvent.path > 0.2
                ? (b = !0)
                : (a.isChanging = -1)
              : a.moveEvent.path < 0 &&
                (a.moveEvent.path < -0.2 ? (b = !0) : (a.isChanging = -1)),
            b &&
              (a.$el.addClass("is-busy"),
              a.$el.children(".is-active").children("video").length &&
                a.$el.children(".is-active").children("video")[0].pause(),
              (a.active = a.moveEvent.targedID),
              a.$el.children(".is-active").removeClass("is-active"),
              a.$el.children("div").eq(a.active).addClass("is-active"),
              a.$el.children(".is-active").children("video").length &&
                a.$el.children(".is-active").children("video")[0].play(),
              (a.isChanging = 1)),
      ...
      this.$el.parent()[0].addEventListener("wheel", function (b) {
        0 === a.isChanging &&
          (b.timeStamp - a.wheelTime > a.options.wheelSensitive
            ? (b.deltaY > 0 && a.nextSlide(), b.deltaY < 0 && a.prevSlide())
            : b.preventDefault()),
      ...
      !0 == this.options.nav &&
        (this.$el.append(
          `<a href="#" class="anita-gallery-nav anita-gallery-nav__prev">` +
            (a.$el.attr("data-prev-label")
              ? "<span>" + a.$el.attr("data-prev-label") + "</span>"
              : "") +
            `</a><a href="#" class="anita-gallery-nav anita-gallery-nav__next">` +
            (a.$el.attr("data-next-label")
              ? "<span>" + a.$el.attr("data-next-label") + "</span>"
              : "") +
            `</a>`
        ),
        this.$el.on("click", ".anita-gallery-nav__prev", function (b) {
  ...
  prevSlide() {
    this.isChanging ||
      ((this.active -= 1),
      this.active < 0 && (this.active = this.max),
      (this.screen.material.uniforms.dir.value = -1),
      this.changeSlide());
  }
  nextSlide() {
    this.isChanging ||
      ((this.active += 1),
      this.active > this.max && (this.active = 0),
      (this.screen.material.uniforms.dir.value = 1),
      this.changeSlide());
  }
  changeSlide() {
    this.isChanging ||
      ...
      (this.screen.material.uniforms.nextImage.value =
        this.gallery[this.active].src),
      (this.screen.material.uniforms.nextZoom.value =
        this.gallery[this.active].zoom),
      (this.isChanging = 1));
  }
  layout() {
    let c = this,
    ...
    this.renderer.setSize(b, a),
      this.renderer.setSize(b, a),
      (this.camera.fov =
        (180 * (2 * Math.atan(a / 2 / this.options.perspective))) / Math.PI),
      (this.camera.aspect = b / a),
      this.camera.updateProjectionMatrix(),
      (this.screen_ratio = a / b),
      this.screen.scale.set(window.innerWidth, window.innerHeight, 1),
      jQuery(this.gallery).each(function (a) {
        "cover" == c.options.fit
          ? this.ratio > c.screen_ratio
            ? ((this.zoom.x = 1), (this.zoom.y = c.screen_ratio / this.ratio))
            : this.ratio < c.screen_ratio &&
              ((this.zoom.x = this.ratio / c.screen_ratio), (this.zoom.y = 1))
          : this.ratio > c.screen_ratio
          ? ((this.zoom.x = this.ratio / c.screen_ratio), (this.zoom.y = 1))
          : this.ratio < c.screen_ratio &&
            ((this.zoom.x = 1), (this.zoom.y = c.screen_ratio / this.ratio)),
          a == c.active &&
            (c.screen.material.uniforms.nextZoom.value = this.zoom);
      });
  }
  animate() {
    "undefined" != typeof stats && stats.begin(),
      (this.anim = requestAnimationFrame(() => this.animate()));
    let b = this.clock.getElapsedTime(),
      a = b - this.prevTime;
    (this.prevTime = b),
      1 == this.isChanging &&
        ((this.screen.material.uniforms.progress.value +=
          (1.5 - this.screen.material.uniforms.progress.value) * 1.2 * a),
        this.screen.material.uniforms.progress.value >= 1 &&
          ((this.screen.material.uniforms.currentImage.value =
            this.gallery[this.active].src),
          (this.screen.material.uniforms.currentZoom.value =
            this.gallery[this.active].zoom),
          (this.screen.material.uniforms.progress.value = 0),
          (this.isChanging = 0),
          this.$el.removeClass("is-busy"))),
      -1 == this.isChanging &&
        ((this.screen.material.uniforms.progress.value +=
          (-0.5 - this.screen.material.uniforms.progress.value) * 1.2 * a),
        this.screen.material.uniforms.progress.value <= 0 &&
          ((this.screen.material.uniforms.progress.value = 0),
          (this.isChanging = 0))),
      this.cameraFixed
        ? (this.camera.position.z +=
            (this.options.zoomed - this.camera.position.z) * a)
        : jQuery("body").hasClass("anita-show-menu")
        ? (this.camera.position.z +=
            (this.options.zoomed - this.camera.position.z) * a * 2)
        : (this.camera.position.z +=
            (this.options.perspective - this.camera.position.z) * a),
...
jQuery(".anita-gl-slider-gallery").length &&
  jQuery.getScript("static/js/lib/three.min.js").done(function () {
    let a = jQuery(".anita-gl-slider-gallery"),
      b = {
